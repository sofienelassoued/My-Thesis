...
from render import graph_generater,snapshot_creator,display
...
'''
    ...
    def reward(self,Next_state,fired): 
        ...
        if  (int(self.petri.marking[IOB1])+int(self.petri.marking[IOB2]))>=self.goal:
        ...
        elif self.petri.delivered1<int(self.petri.marking[IOB1]):       
            # a piece is delivered       
            reward=+7 
            firing_info="a piece 1 is delivered  "
            
            
        elif self.petri.delivered2<int(self.petri.marking[IOB2]):       
        # a piece is delivered       
            reward=+7 
            firing_info="a piece 2 is delivered  "
        ...
        self.petri.delivered1=int(self.petri.marking[IOB1]) 
        self.petri.delivered2=int(self.petri.marking[IOB2])
