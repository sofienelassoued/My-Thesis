...
def Tree_creator(Nodes,simulation_clock):
...
def display(speed,grafic_container,saved_render,replay=False,continues=True,index=0):  
          
          position=(0,0)
          clock = pygame.time.Clock() 
          
          try:
           display_width = (grafic_container[index].get_width())
           display_height =(grafic_container[index].get_height())
